...
public class TextParser {
	...
	/**
	 * @brief Cleans the text by removing any non-alphabetic characters (e.g. non-letters
	...
	/**
	 * @brief Splits the supplied text by whitespaces.
	 *
	...
	/**
	 * @brief Parses the text into an array of clean words.
	 *
